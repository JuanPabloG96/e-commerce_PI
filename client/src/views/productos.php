        ...
        <div class="container mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <nav>
                <ul class="flex space-x-4">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-violet-300">Categorías</a></li>
    ...
    <main class="container mx-auto px-6 py-12">
        ...
        <div class="mb-8">
            <div class="flex flex-col md:flex-row gap-4">
                <input type="text" placeholder="Buscar productos..." class="flex-grow px-4 py-2 bg-gray-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500">
                <select class="px-4 py-2 bg-gray-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500">
                    <option value="">Todas las categorías</option>
                    <option value="electronica">Electrónica</option>
                    <option value="ropa">Ropa</option>
                    <option value="hogar">Hogar</option>
                </select>
                <button class="px-6 py-2 bg-violet-600 text-white rounded-md hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-violet-500">
                    Buscar
                </button>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-gray-800 rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-400 mb-4">Descripción breve del producto 1. Este es un ejemplo de texto para mostrar dónde iría la descripción del producto.</p>
                    <div class="flex justify-between items-center">
                        <span class="text-2xl font-bold text-violet-300">$19.99</span>
                        <button class="px-4 py-2 bg-violet-600 text-white rounded-md hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-violet-500">
                            Agregar al carrito
                        </button>
                    </div>
                </div>
            ...
            <div class="bg-gray-800 rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-400 mb-4">Descripción breve del producto 2. Este es un ejemplo de texto para mostrar dónde iría la descripción del producto.</p>
                    <div class="flex justify-between items-center">
            ...
            <div class="bg-gray-800 rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-400 mb-4">Descripción breve del producto 3. Este es un ejemplo de texto para mostrar dónde iría la descripción del producto.</p>
                    <div class="flex justify-between items-center">
            ...
            <div class="bg-gray-800 rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-400 mb-4">Descripción breve del producto 4. Este es un ejemplo de texto para mostrar dónde iría la descripción del producto.</p>
                    <div class="flex justify-between items-center">
            ...
            <div class="bg-gray-800 rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-400 mb-4">Descripción breve del producto 5. Este es un ejemplo de texto para mostrar dónde iría la descripción del producto.</p>
                    <div class="flex justify-between items-center">
            ...
            <div class="bg-gray-800 rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-400 mb-4">Descripción breve del producto 6. Este es un ejemplo de texto para mostrar dónde iría la descripción del producto.</p>
                    <div class="flex justify-between items-center">
        ...
        <div class="mt-8 flex justify-center">
            <nav class="inline-flex rounded-md shadow-sm" aria-label="Pagination">
                ...
                <a href="#" class="relative inline-flex items-center px-4 py-2 border border-gray-700 bg-violet-600 text-sm font-medium text-white">
                    2
                </a>
                <a href="#" class="relative inline-flex items-center px-4 py-2 border border-gray-700 bg-gray-800 text-sm font-medium text-gray-400 hover:bg-gray-700">
                    3
