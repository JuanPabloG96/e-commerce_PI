...
<body class="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-gray-100">
        ...
        <div class="container mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <nav>
                <ul class="flex space-x-4">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-violet-300">Productos</a></li>
    ...
    <main class="container mx-auto px-6 py-12">
            ...
            <table class="w-full">
                ...
                <tbody class="bg-gray-800 divide-y divide-gray-700">
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <input type="number" value="1" min="1" class="w-16 px-2 py-1 bg-gray-700 border border-gray-600 rounded-md text-white focus:outline-none focus:border-violet-500">
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <input type="number" value="2" min="1" class="w-16 px-2 py-1 bg-gray-700 border border-gray-600 rounded-md text-white focus:outline-none focus:border-violet-500">
                        </td>
        ...
        <div class="bg-gray-800 rounded-lg shadow-md p-6">
            ...
            <button class="w-full mt-6 px-4 py-2 bg-violet-600 text-white rounded-md hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-violet-500">
                Proceder al pago
            </button>
        </div>
        ...
        <div class="mt-8">
            ...
            <div class="flex">
                <input type="text" placeholder="Ingrese su código" class="flex-grow px-4 py-2 bg-gray-700 text-white rounded-l-md focus:outline-none focus:ring-2 focus:ring-violet-500">
